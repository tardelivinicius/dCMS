        ...
        <div id="news-content">
            <div class="news-article show" style="background-image:url(/img/web_promo/ABBOBADOS_P01.png)">
                ...
                <div class="news-content">
                    <div class="news-title">Bem vindo ao painel de controle <br> do CMS!</div>
                    <div class="news-short-text">{{ $hotel_name }} - Versão 1.0.0 <br> Painel - Versão 1.0.0</div>
                </div>
            </div>
        </div>
        <div class="png20">
            <p>TO-DO - ADICIONAR MAIS INFOS AQUI EMBAIXO</p>
        </div>
    </div>
</div>
