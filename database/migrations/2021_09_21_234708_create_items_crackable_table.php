...
class CreateItemsCrackableTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('items_crackable', function (Blueprint $table) {
            ...
            $table->string('item_name', 255)->comment('Item name for identification');
            $table->integer('count');
            $table->string('prizes', 255)->default('179:1')->comment('Used in the format of item_id:chance;item_id_2:chance. item_id must be id in the items_base table. Default value for chance is 100.');
            ...
            $table->string('subscription_type', 255)->nullable()->comment('hc for Habbo Club, bc for Builders Club');
